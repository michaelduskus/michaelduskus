...
$(document).ready(function() {
    $('.dribbble_list').bra_photostream({user: 'duskus', 
										limit:10, 
										social_network: 'dribbble'});
	
	$('.pinterest_list').bra_photostream({user: 'duskus', 
										 limit:10, 
										 social_network: 'pinterest'});
	
	$('.flickr_list').bra_photostream({user: 'michaelography', 
									  limit:10, 
									  social_network: 'flickr'});
		
	$('.flickr_list_footer').bra_photostream({user: 'michaelography', 
									  limit:9, 
									  social_network: 'flickr'});
});
